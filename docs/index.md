...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-42](https://github.com/mvaldron-rhdh/chatbot-test-app-42)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-42-gitops](https://github.com/mvaldron-rhdh/chatbot-test-app-42-gitops)

# **Usage**

To access the chatbot-test-app-42 application that was deployed using the Software Template, complete the following instructions:
